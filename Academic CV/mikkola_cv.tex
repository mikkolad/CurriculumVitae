...
\leftheader{%
  {\LARGE\bfseries\sffamily Curriculum Vitae: Daniel Mikkola}

  \vspace{10pt}\makefield{\faEnvelope[regular]}{\texttt{\href{mailto:mikkola@astro.lu.se}{mikkola@astro.lu.se}}}
 % \makefield{\faTwitter}{\texttt{@example}}

  \makefield{\faGlobe}{\url{http://www.astro.lu.se/~mikkola/}}
